"""
lambda function 
defnition:anony,ous function with single expression
syntax:
var_name=lambda p1p2:expression
"""
...
total_countries=[l for l in countries_data]
# print(len(total_contries))
total_asia_countries=[l for l in countries_data if l.get("region")=="Asia"]
# print(len(total_asia_countries))
# high_population=max([l.get("population")for l in countries_data])
# country=[lst.get("country_name")for lst in countries_data if lst.get("population")==high_population]
pop_max=max(countries_data,key=lambda l:l.get("population"))
# print(pop_max.get("country_name"))
# print(country)
sort_countries=sorted(countries_data,key=lambda l:l.get("population"))
sort=[[l.get("country_name"),l.get("population")] for l in sort_countries]
print(sort)
